...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  UnauthorizedAdmin: 'Connected wallet is not the owner or configured admin.',
  InsufficientVaultBalance: 'The vault does not have enough USDC liquidity.',
  InsufficientReservedInterest: 'Reserved interest accounting is lower than the requested release.',
  SavingCoreAlreadyLocked: 'The authorized SavingCore address has been permanently locked.',
  DepositMarketplaceAlreadyLocked: 'The authorized marketplace address has been permanently locked.',
  InterestUnavailable: 'The vault cannot pay this interest yet. You can withdraw principal or claim later after funding.',
  NoUnpaidInterest: 'There is no unpaid interest to claim.',
  NotInterestClaimant: 'Only the stored interest claimant can claim this interest.',
